...
type CompanyPageProps = {
  navigation: NativeStackNavigationProp<RootStackParamList, 'Company'>;
};

export default function CompanyPage({ navigation }: CompanyPageProps) {
